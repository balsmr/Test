...
function Send-notification {
    ...
    $notify.icon = [System.Drawing.SystemIcons]::Information #A garder pour desiner icone, mais le choix de l'icone se fait dasn dernière ligne
    $notify.visible = $true
    $notify.showballoontip($Duree,$Titre,$Message,[system.windows.forms.tooltipicon]::$Icone)
...
Send-notification -titre "Test notifications" -message "message de test"
